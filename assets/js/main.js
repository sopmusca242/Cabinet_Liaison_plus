...
window.addEventListener('scroll', function() {
  ...
  if (window.scrollY > 50) {
    ...
    logo.src = 'assets/ico2.png';
    console.log('Changement logo vers blanc:', logo.src);
  } else {
    navbar.classList.remove('scrolled');
    logo.src = 'assets/ico1.png';
    console.log('Changement logo vers original:', logo.src);
  }
});
...
window.addEventListener('scroll', function() {
    const navbar = document.querySelector('.navbar'); // ou getElementById si vous avez un ID
